""" "
Quick script to verify AWS S3 creadentials and permissions.

Run with: uv run check_s3.py

This checks that your .env creadentials can upload to and delete from your S3 bucket
...
def check_s3_connection():
    ...
    print(f"Bucket: {settings.s3_region}")
    print()
